...
urlpatterns = [
    ...
    path('warranties/<int:warranty_id>/edit/', views.edit_warranty, name='edit_warranty'),
    path('warranties/<int:warranty_id>/delete/', views.delete_warranty, name='delete_warranty'),
    path('inspections/', views.inspections_view, name='inspections'),
    path('inspections/<int:inspection_id>/edit/', views.edit_inspection, name='edit_inspection'),
    path('inspections/<int:inspection_id>/delete/', views.delete_inspection, name='delete_inspection'),
